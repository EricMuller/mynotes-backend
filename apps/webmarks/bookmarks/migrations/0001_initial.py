...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='node_ptr',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='webmarks_core.Node'),
        ),
        migrations.AddField(
            model_name='historicalbookmark',
            name='user_cre',
        ...
        migrations.AddField(
            model_name='archive',
            name='bookmark',
            field=models.ForeignKey(blank=True, default=None, on_delete=django.db.models.deletion.CASCADE, related_name='archive_archives', to='webmarks_bookmarks.Bookmark'),
        ),
