# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-05-20 19:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='bookmarks.Model')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='Bookmark',
            fields=[
                ('node_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='bookmarks.Node')),
                ('title', models.CharField(max_length=256)),
                ('url', models.CharField(default=None, max_length=2000, null=True)),
                ('description', models.TextField(blank=True)),
                ('archived_dt', models.DateTimeField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(db_index=True, editable=False)),
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='bookmarks.Folder')),
            ],
            options={
                'abstract': False,
            },
            bases=('bookmarks.node', models.Model),
        ),
        migrations.AddField(
            model_name='search',
            name='tags',
            field=models.ManyToManyField(related_name='tags_search', to='bookmarks.Tag'),
        ),
        migrations.AddField(
            model_name='search',
            name='user_cre',
        ...
        migrations.AddField(
            ...
            name='node_ptr',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='bookmarks.Node'),
        ),
        migrations.AddField(
            model_name='historicalbookmark',
            name='user_cre',
        ...
        migrations.AddField(
            model_name='bookmark',
            name='tags',
            field=models.ManyToManyField(blank=True, related_name='tags', to='bookmarks.Tag'),
        ),
        migrations.AddField(
            model_name='archive',
            name='bookmark',
            field=models.ForeignKey(blank=True, default=None, on_delete=django.db.models.deletion.CASCADE, related_name='archives', to='bookmarks.Bookmark'),
        ),
    ]
